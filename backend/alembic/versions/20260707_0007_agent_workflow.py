...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("severity_stats", sa.JSON, nullable=False, server_default="'{}'"),
        sa.Column("issue_type_stats", sa.JSON, nullable=False, server_default="'{}'"),
        ...
        sa.Column("degradation_summary", sa.JSON, nullable=False, server_default="'{}'"),
        sa.Column(
            "created_at",
            sa.DateTime(),
            nullable=False,
